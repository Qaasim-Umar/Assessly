...
function mapDbToForm(exam: DbExamWithQuestions): ExamForm {
    return {
        ...
        source: "manual",
        showResults: true, // Always true for general mode
    };
}

export default function GeneralEditExamPage() {
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-20 shadow-sm">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-gray-900">Edit General Exam</span>
                    </div>
                </div>
            </header>
                    ...
                    {step === 0 && (
                        <div className="space-y-5 max-w-2xl">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Edit basic details. This exam is public.</p>
                            </div>
                    ...
                    {step === 2 && (
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Review and save your changes to the public exam.</p>
                            </div>
                            <FinalizeStep
                                questions={questions}
                                form={form}
