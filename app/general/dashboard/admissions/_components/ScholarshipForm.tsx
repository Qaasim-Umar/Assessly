            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        ...
                        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                            <Label>SEO Summary <span className="text-gray-400 font-normal normal-case">(card, search &amp; meta description)</span></Label>
                            <p className="text-[11px] text-gray-400 mt-0.5 mb-1 leading-relaxed">
                                One or two plain sentences. Used for the search preview and the page&apos;s meta description — keep it short.
                            </p>
                            <textarea value={form.description} onChange={e => set("description", e.target.value)} placeholder="Brief summary of who qualifies and what it covers…" rows={2} className="w-full text-sm text-gray-700 placeholder:text-gray-300 border-0 outline-none resize-none mt-1" />
                        </div>

                        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                            <Label>Body <span className="text-gray-400 font-normal normal-case">(full detail page — Markdown)</span></Label>
                            <p className="text-[11px] text-gray-400 mt-0.5 mb-1 leading-relaxed">
                                Paste or write the full article in Markdown: <code className="bg-gray-100 px-1 rounded">## Heading</code>, <code className="bg-gray-100 px-1 rounded">**bold**</code>, <code className="bg-gray-100 px-1 rounded">- list</code>, <code className="bg-gray-100 px-1 rounded">1. steps</code>, <code className="bg-gray-100 px-1 rounded">[link](url)</code>, tables and quotes all render.
                            </p>
                            <textarea value={form.body} onChange={e => set("body", e.target.value)} placeholder={"## Who Can Apply\n- Nigerian citizen enrolled in a Nigerian university\n\n## What to Prepare\n- WAEC result slip\n\n## What's Covered\n- Full tuition fees"} rows={20} className="w-full text-sm text-gray-700 placeholder:text-gray-300 border-0 outline-none resize-y mt-1 font-mono leading-relaxed" />
                        </div>
                    </div>
