    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            if (username === "test" && password === "test") {
                localStorage.setItem("assessly_auth", "true");
                router.push("/");
            } else {
        ...
        <div className="min-h-screen bg-[#f0f2f5] flex flex-col items-center justify-center px-4">
            ...
            <div className="w-full max-w-sm bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="bg-blue-700 px-8 py-7 text-center">
                    ...
                    <p className="text-blue-200 text-xs mt-1">CBT Examination Portal</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="px-8 py-7 space-y-5">
                    <div className="text-center mb-1">
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">Enter your credentials to access your exams</p>
                    </div>

                    {/* Error */}
                    {error && (
                        <div className="flex items-start gap-2.5 bg-red-50 border border-red-200 text-red-700 text-xs px-3.5 py-3 rounded-lg">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 placeholder-gray-400 text-gray-900"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-11 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 placeholder-gray-400 text-gray-900"
                            />
                            <button
                                type="button"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-2 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 disabled:opacity-70 text-white font-bold text-sm py-3 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
                        {loading ? (
                            <>
            ...
            <p className="text-xs text-gray-400 mt-6 text-center">
                Assessly CBT System &copy; {new Date().getFullYear()}
            </p>
        </div>
    );
}
