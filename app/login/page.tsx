...
import { studentEnter, getStudentSession } from "@/lib/authService";
...
export default function StudentLoginPage() {
    ...
    // Already entered → go straight to portal
    useEffect(() => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            await studentEnter(fullName.trim(), schoolCode.trim().toUpperCase());
            router.push("/student");
        } catch (e: unknown) {
