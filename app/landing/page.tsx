...
export default function LandingPage() {
    ...
    const jsonLd = {
        ...
        "@graph": [
            { "@type": "Organization", "@id": "https://assessly.app/#organization", name: "Assessly", url: "https://assessly.app", description: "Nigeria's leading Computer-Based Testing (CBT) platform for secondary schools." },
            { "@type": "WebSite", "@id": "https://assessly.app/#website", url: "https://assessly.app", name: "Assessly", publisher: { "@id": "https://assessly.app/#organization" } },
            { "@type": "WebPage", "@id": "https://assessly.app/landing", url: "https://assessly.app/landing", name: "Assessly - Smart CBT Exams for Nigerian Schools", isPartOf: { "@id": "https://assessly.app/#website" } },
        ],
    };
                ...
                <div className="lp-section-inner">
                    ...
                    <div className="lp-pricing-grid">
                        ...
                        <div className="lp-pricing-card">
                            ...
                            <a href="mailto:hello@assessly.app" className="lp-plan-cta lp-cta-outline">Talk to us</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <footer className="lp-footer">
                <div className="lp-footer-inner">
                    <div className="lp-footer-top">
                        <div>
                            <Link href="/landing" className="lp-footer-logo">Assessly</Link>
                        ...
                        <div>
                            ...
                            <ul className="lp-footer-links">
                                <li><a href="mailto:hello@assessly.app">Contact</a></li>
